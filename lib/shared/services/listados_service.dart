...
class ListadosService {
  ...
  static const String _incidenteEndpoint =
      '$_baseUrl/ser_sien_dsp_incidente/recientes?expand=ultimoEstadoRel.estadoRel';
  ...
  static Future<List<Map<String, dynamic>>> obtenerDemandasRecibidas() async {
    try {
      ...
      final responseIndex = await http.get(
        Uri.parse('$_baseUrl/ser_sien_dsp_incidente?per-page=100&expand=ultimoEstadoRel.estadoRel'),
        headers: _getHeaders(),
      );
